...
const GetInvolved = () => {
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 bg-gradient-to-b from-snpw-green-light/30 to-white">
        <div className="container-padding text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-700 mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Your support can help women gain skills, independence, and confidence. There are many ways to get involved with SNPWS.
          </p>
        </div>
      </section>
        ...
        <div className="container-padding">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 hover-scale">
              <Heart className="w-12 h-12 text-snpw-green mb-6" />
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <span className="text-snpw-green mr-2">✓</span>
              ...
              <Button className="w-full bg-snpw-green-light hover:bg-snpw-green text-snpw-green hover:text-white">
                Apply to Volunteer
              </Button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 hover-scale">
              <Briefcase className="w-12 h-12 text-snpw-blue mb-6" />
              <h3 className="text-xl font-bold mb-4">Corporate Partnerships</h3>
              <p className="text-gray-700 mb-6">
                Partner with SNPWS as part of your corporate social responsibility initiatives. Your company can make a significant impact while gaining meaningful visibility.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <span className="text-snpw-blue mr-2">✓</span>
              ...
              <Button className="w-full bg-snpw-blue-light hover:bg-snpw-blue text-snpw-blue hover:text-white">
                Become a Partner
              </Button>
            </div>
            ...
            {/* Donate Materials */}
            <div className="bg-white rounded-xl shadow-md p-8 hover-scale">
              <Gift className="w-12 h-12 text-snpw-green mb-6" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-padding max-w-4xl mx-auto">
          <div className="p-8 bg-white rounded-xl shadow-md">
            <div className="text-4xl text-snpw-green mb-4">"</div>
            <p className="text-lg italic text-gray-700 mb-6">
              Volunteering with SNPWS has been one of the most rewarding experiences of my life. Seeing the direct impact of our work on women's lives and watching them grow their confidence and skills is truly amazing.
            </p>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-snpw-green-light/50">
        <div className="container-padding text-center">
          ...
          <Button className="fancy-button bg-snpw-green hover:bg-snpw-green-dark text-white px-8 py-6 h-auto text-lg">
